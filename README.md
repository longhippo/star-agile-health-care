...
pipeline {
    ...
    stages {
        stage('Checkout from GitHub') {
            steps {
                git branch: 'master', url: 'https://github.com/longhippo/star-agile-health-care.git'
            }
        }
            ...
            steps {
                script {
                    sh """
                        ...
                        docker run -d --name star-agile-insurance-project -p 3000:8082 subkamble/star-agile-insurance-project:latest
